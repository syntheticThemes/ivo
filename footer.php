											...
											<div class="row inside">
												<div id="footer-2m05kacnwa9"
													...
													<div class="row">
														<div class="col-sm-12 section-element-inside ">
															<div class="site-info">
																<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'ivo' ) ); ?>">
																	<?php
																		/* translators: %s: CMS name, i.e. WordPress. */
																		printf( esc_html__( 'Proudly powered by %s', 'ivo' ), 'WordPress' );
																	?>
																</a>
																<span class="sep"> | </span>
																<?php
																	/* translators: 1: Theme name, 2: Theme author. */
																	printf( esc_html__( 'Theme: %1$s by %2$s.', 'ivo' ), 'ivo', '<a href="https://github.com/syntheticThemes/ivo">IVo</a>' );
																?>
															</div><!-- .site-info -->
														</div>
													</div>
